...
from datasets import CombinedDataset, denorm
...
class Trainer(object):
    ...
    def train(self):
        ...
        # CHANGES MADE TO INCLUDE EARLY STOPPING
    ...
    def load(self, gen_resume, dis_resume):
        ...
        device = "cuda:3" if self.is_cuda else "cpu"
        print("==============================================")
        print(device)
...
if __name__ == "__main__":
    ...
    # Build data loaders
    train_set = CombinedDataset(args.data, (256, 256), "train")
    valid_set = CombinedDataset(args.data, (256, 256), "valid")
